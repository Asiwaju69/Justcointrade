...
const Hero = () => {
        ...
        return (
            <section className='relative w-full h-full' style={{ background: "linear-gradient(143.6deg, rgba(192, 132, 252, 0) 20.79%, rgba(232, 121, 249, 0.26) 40.92%, rgba(204, 171, 238, 0) 70.35%)", backgroundColor: "#F0CAE3" }} >
                <video src={vid} autoPlay  className='w-screen -z-5 h-full absolute top-0 left-0 opacity-20'/>
                <div className="xl:py-32  max-w-screen-xl mx-auto px-4 py-28 gap-12 text-gray-600 md:px-8 xl:block">
