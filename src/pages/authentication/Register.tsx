...
<div className="flex items-center py-4 mt-2 px-2">
    ...
    <label htmlFor="link-checkbox" className="ms-2 text-sm font-medium text-gray-900 ">I agree with the <a href="#" className="text-[var(--background)]  dark:text-[var(--background)]  hover:underline">terms and conditions</a>.</label>
</div>

                        </div>
                        <button  style={{ background: "linear-gradient(98.7deg,#5240f9 19.95%,#f3526d 89.51%)" }}
                            className="w-full px-4 py-3 text-white font-medium  hover:bg-[var(--background)]  active:bg-[var(--background)]  rounded-lg duration-150"
                        >
                            Create account
                        </button>
                    </form>
